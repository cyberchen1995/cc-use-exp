...
3. 需要项目级说明时，以 `assets/AGENTS.project.md` 为起点生成仓库根目录 `AGENTS.md`，内容聚焦项目特定约定，不重复用户级全局规则。若项目包含 Java 代码，需遵守项目署名约定：文档和代码署名统一使用 `wwj`，新增 Java 文件或补齐文件头注释时使用 `@author wwj`。

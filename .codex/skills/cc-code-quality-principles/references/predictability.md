...
- `cc-time-zone-safety`：时间处理具体规范
- `cc-redis-safety`：Redis 幂等键的具体写法
- `cc-query-performance-safety`：N+1 等性能陷阱
- `cc-payment-callback-safety`：支付回调幂等性的专项
